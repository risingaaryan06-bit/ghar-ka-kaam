const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D8faD2En.js","assets/index-D5ASyzS6.js","assets/index-Mwr2-Edf.css"])))=>i.map(i=>d[i]);
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
import { w as Subscribable, x as shallowEqualObjects, y as hashKey, z as getDefaultState, A as notifyManager, D as useQueryClient, r as reactExports, E as noop, F as shouldThrowError, _ as __vitePreload } from "./index-D5ASyzS6.js";
import { U as UserRole, c as createActor } from "./types-D7fAxLqk.js";
import { u as useActor, a as useQuery } from "./useActor-BVPqwPhj.js";
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { Principal } = await __vitePreload(async () => {
        const { Principal: Principal2 } = await import("./index-D8faD2En.js").then((n) => n.i);
...
export {
  useGetMessagesForJob as a,
  useGetPaymentsForJob as b,
  useGetCallerProfile as c,
  useSendMessage as d,
  useGetUserProfile as e,
  useCreateReview as f,
  useListJobs as g,
  useFilterJobs as h,
  ...
  useListMaids as k,
  usePostJob as l,
  useGetMyPostedJobs as m,
  useGetMyNotifications as n,
  useMarkNotificationRead as o,
  useMarkAllNotificationsRead as p,
  useSaveCallerUserProfile as q,
  useGetJob as u
};
